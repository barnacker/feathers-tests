...
program
  ...
  .option(
    ...
    'Total # of scenarios performed by each virtual client before disconnecting',
    '100',
  )
...
logger.info(
  'Launching ' +
    cpus * options.maxConcurrentCallsPerWorker +
    ' concurrent client(s) with ' +
    cpus +
    ' CPUs until ' +
    total +
    ' have been executed',
...
for (var i = 0; i < total; i++) {
  ...
  let workerOptions = {
    ...
    jwtRatio: parseFloat(program.jwt),
    index: i + 1,
    nbScenarios,
  };
